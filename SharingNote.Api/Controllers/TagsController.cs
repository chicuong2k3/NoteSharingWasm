...
using SharingNote.Api.Controllers.Requests.Tags;
...
namespace SharingNote.Api.Controllers
{
    ...
    public class TagsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Application.Features.Tags.GetTags.TagDto>>> GetAll([FromQuery] GetTagsQuery query)
        {
