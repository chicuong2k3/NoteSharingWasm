...
namespace SharingNote.Api.Infrastructure.Database.Migrations
{
    ...
    [Migration("20241118184516_AddInteractionCount")]
    partial class AddInteractionCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharingNote.Api.Domain.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SharingNote.Api.Domain.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SharingNote.Api.Domain.Comment", b =>
                {
                    b.HasOne("SharingNote.Api.Domain.Comment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TagPosts", b =>
                {
                    ...
                    b.HasOne("SharingNote.Api.Domain.Tag", null)
                        .WithMany()
